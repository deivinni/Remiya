...
module.exports = {
    run: async(msg) => {
        ...
        get(msg.config.get_images.nekos.nsfw.classic).then(r => {
            msg.channel.send(embed.seImage(r.body.url)).then(message => {
                ...
                collector.on('collect', (r) => {
                    switch (r.emoji.id) {
                        case msg.config.e_id.reload_:
                            get(msg.config.get_images.nekos.nsfw.classic).then(r1 => {
