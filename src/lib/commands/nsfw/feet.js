...
module.exports = {
    run: async(msg) => {
        ...
        let get_image = msg.args[0] == '--gif' ? msg.config.get_images.nekos.nsfw.feetGif : msg.args[0] == '--ero' ? msg.config.get_images.nekos.nsfw.eroFeet : msg.config.get_images.nekos.nsfw.feet
