...
module.exports = {
    run: async(msg) => {
        ...
        .setTimestamp();
        let get_image;
        if (msg.args[0] == '--ero') get_image = msg.config.get_images.nekos.nsfw.eroKemonomimi;
        if (!msg.args[0])           get_image = msg.config.get_images.nekos.nsfw.kemonomimi;
    ...
    help: {
        ...
        usage: ['kemonomimi','kemonomimi --ero'],
        member: 'usuários',
        category: 'nsfw'
    }
}