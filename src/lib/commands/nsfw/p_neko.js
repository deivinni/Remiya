...
module.exports = {
  run: async(msg) => {
    ...
    let get_image = msg.args[0] == '--gif' ? 'https://nekos.life/api/v2/img/nsfw_neko_gif' : msg.args[0] == '--ero' ? 'https://nekos.life/api/v2/img/eron' : 'https://nekos.life/api/v2/img/lewd';
